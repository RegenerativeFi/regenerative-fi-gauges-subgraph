...
export const LOCK_MAXTIME = BigInt.fromI32(52 * 604800); // 1 YEAR
...
let controllerAddressByNetwork: AddressByNetwork = {
  ...
  celoAlfajores: '0x0B58399530a0664C0B1ad7e7d290fFAC854930f8',
};
...
// export function isCeloAlfajoresFactory(factory: Address): boolean {
//   return (
//     factory == Address.fromString('0x0B58399530a0664C0B1ad7e7d290fFAC854930f8')
//   );
// }
